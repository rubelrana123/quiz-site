...
import { BeakerIcon ,ChevronDoubleDownIcon , ChevronDoubleUpIcon } from '@heroicons/react/24/solid';
const BlogQuestion = ({info}) => {
   const {question , answer } = info;
   const [open , setOpen] = useState(true);
  return (
		<div className='flex align-center justify-center flex-col'>
			<div className='flex justify-between p-5 w-auto bg-blue-300 w-96 border'>
				<h1>{question}</h1>
